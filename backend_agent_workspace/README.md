...
```bash
# Run all tests
pytest backend_agent_workspace/tests/test_nodes.py -v

# Run specific test class
pytest backend_agent_workspace/tests/test_nodes.py::TestAPIContract -v

# Run with coverage
pytest backend_agent_workspace/tests/test_nodes.py --cov=backend_agent_workspace
```
...
1. **Test locally** → `pytest backend_agent_workspace/tests/ -v`
2. **Run workflow** → `python backend_agent_workspace/agents/workflow.py`
